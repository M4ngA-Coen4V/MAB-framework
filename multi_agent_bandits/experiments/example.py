...
from multi_agent_bandits.core.reward_sharing import linear_share, zero_on_collision, winner_takes_all, custom_100_20_10_share
...
def main(steps=1000, save_dir=None, plot_rewards=False, plot_frequencies=False):
    ...
    env = Environment(
        n_agents=n_agents,
        arms=arms,
        collision_policy=custom_100_20_10_share
    )
